...
public class ProfileServiceImpl implements ProfileService {
    ...
    public ProfileResponse updateProfile(String userId, ProfileRequest profileRequest) {
        ...
        var profileBytes = ByteHandlerUtil.byteGenerator(profile.getProfile());

        profile.setProfile(mapper.requestToEntity(profileRequest));
        profile.setHashObject(generateSHAHashObject(profile.toString()));

        var newProfileBytes = ByteHandlerUtil.byteGenerator(profile.getProfile());

        log.info("Checking whether the generated byte arrays are equals");
        if (!ByteHandlerUtil.byteArrayComparison(profileBytes, newProfileBytes)) {
    ...
    public ProfileResponse patchProfile(String userId, Map<String, Object> profileRequestMap) {
        ...
        try {
            ...
            var dbProfileRequestMap = ObjectMapperUtil.objectMapper
                    .readValue(ObjectMapperUtil.objectMapper.writeValueAsString(dbProfileRequest), Map.class);
            ...
            dbProfileRequest = ObjectMapperUtil.objectMapper.readValue(
                    ObjectMapperUtil.objectMapper.writeValueAsString(dbProfileRequestMap), ProfileRequest.class);
